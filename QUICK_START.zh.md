...
| 命令 | 说明 |
|------|------|
| `tia-mapper init` | 初始化映射数据库 |
| `tia-mapper map` | 从覆盖率数据添加映射 |
| `tia-mapper stats` | 查看数据库统计信息 |
| `tia-mapper query` | 查询文件被哪些测试覆盖 |
...
- [完整文档](docs/architecture.zh.md)
- [详细集成指南](docs/integration-guide.zh.md)
- [Dashboard 使用](docs/dashboard.zh.md)
- [E2E 测试示例](tests/e2e/README.zh.md)
